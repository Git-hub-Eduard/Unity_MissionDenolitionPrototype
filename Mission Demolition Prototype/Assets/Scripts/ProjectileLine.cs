...
public class ProjectileLine : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Выключить LineRenderer пока не понадобитса
        line.enabled = false;
        // Инициализировать список точек
        points = new List<Vector3>();
    }
    // Это свойство маскируэтса под поле
    ...
    // Этот метод можна вызывать что б стереть линию 
    public void Clear()
    {
        _poi = null;
        line.enabled = false;
    ...
    {
        // Вызываетса для добавления точки в линии
